...
lemma ccorres_get_registers:
  "\<lbrakk> \<And>cptr msgInfo. ccorres dc xfdc
     ((\<lambda>s. P s \<and> Q s \<and>
           obj_at' (\<lambda>tcb. (user_regs o atcbContextGet o tcbArch) tcb RISCV64.capRegister = cptr
                      \<and>   (user_regs o atcbContextGet o tcbArch) tcb RISCV64.msgInfoRegister = msgInfo)
  ...
  apply (erule_tac x="(user_regs o atcbContextGet o tcbArch) ko RISCV64.capRegister" in meta_allE)
